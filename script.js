...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateNowPlaying() {
        ...
        setTimeout(() => {
            ...
            artistNameElement.textContent = randomSong.artist;
            songTitleElement.style.opacity = '1';
            artistNameElement.style.opacity = '1';
        }, 300);

        // Determinar si hay programa en vivo (simulado)
        const isLive = Math.random() > 0.3; // 70% probabilidad de estar en vivo
    ...
    // Actualizar información cada 15-30 segundos
    updateNowPlaying();
    setInterval(updateNowPlaying, Math.random() * 15000 + 15000);
